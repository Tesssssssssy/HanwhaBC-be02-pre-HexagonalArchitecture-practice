package com.example.hexagonalarchitecture.gateway.filter;

import com.example.hexagonalarchitecture.gateway.util.JwtTokenProvider;
...
public class AuthorizationHeaderFilter extends AbstractGatewayFilterFactory<AuthorizationHeaderFilter.Config> {
    // 비동기 방식으로 여러 thread들이 동시에 수행될 수 있도록.
    // Spring Cloud Gateway에서 제공하는 기능을 사용하겠다.
    ...
    public GatewayFilter apply(Config config) {
        return (exchange, chain) -> {
            ...
            // 파싱된 토큰의 claim을 추출해 아이디 값을 가져온다.
